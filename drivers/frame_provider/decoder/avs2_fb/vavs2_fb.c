...
static struct BuffInfo_s amvavs2_workbuff_spec[WORK_BUF_SPEC_NUM] = {
	...
	},
	{
		...
		.cm_header = {
			.buf_size = MMU_COMPRESS_HEADER_SIZE*AVS2_BUFFER_NUM, // 0x44000 = ((1088*2*1024*4)/32/4)*(32/8)
		},
#endif
#ifdef AVS2_10B_MMU_DW
		.mmu_vbh_dw = {
		...
		.cm_header_dw = {
			.buf_size = MMU_COMPRESS_HEADER_SIZE_DW*AVS2_BUFFER_NUM, // 0x44000 = ((1088*2*1024*4)/32/4)*(32/8)
		},
#endif
#else
#ifdef AVS2_10B_MMU
...
#ifdef OW_TRIPLE_WRITE
			dec->avs2_dec.hc.cur_pic->triple_write_mode

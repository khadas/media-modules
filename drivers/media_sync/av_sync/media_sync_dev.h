...
#define MEDIASYNC_IOC_SET_AUDIO_PACKETS_INFO _IOW(MEDIASYNC_IOC_MAGIC, 0x4C, int)
#define MEDIASYNC_IOC_GET_AUDIO_CACHE_INFO _IOW(MEDIASYNC_IOC_MAGIC, 0x4D, int)
#define MEDIASYNC_IOC_SET_VIDEO_PACKETS_INFO _IOW(MEDIASYNC_IOC_MAGIC, 0x4E, int)
...
#define MEDIASYNC_IOC_SET_PAUSE_VIDEO_INFO _IOW(MEDIASYNC_IOC_MAGIC, 0x53, int)
#define MEDIASYNC_IOC_GET_PAUSE_VIDEO_INFO _IOW(MEDIASYNC_IOC_MAGIC, 0x54, int)
#define MEDIASYNC_IOC_SET_PAUSE_AUDIO_INFO _IOW(MEDIASYNC_IOC_MAGIC, 0x55, int)
#define MEDIASYNC_IOC_GET_PAUSE_AUDIO_INFO _IOW(MEDIASYNC_IOC_MAGIC, 0x56, int)

#define MEDIASYNC_IOC_EXT_CTRLS _IOW(MEDIASYNC_IOC_MAGIC, 0x57, mediasync_control)
#define MEDIASYNC_IOC_SET_VIDEO_SMOOTH_FLAG _IOW(MEDIASYNC_IOC_MAGIC, 0x58, int)
#define MEDIASYNC_IOC_GET_VIDEO_SMOOTH_FLAG _IOW(MEDIASYNC_IOC_MAGIC, 0x59, int)
#define MEDIASYNC_IOC_CHECK_APTS_VALID _IOW(MEDIASYNC_IOC_MAGIC, 0x5A, int)
#define MEDIASYNC_IOC_CHECK_VPTS_VALID _IOW(MEDIASYNC_IOC_MAGIC, 0x5B, int)
#define MEDIASYNC_IOC_SET_CACHE_FRAMES _IOW(MEDIASYNC_IOC_MAGIC, 0x5C, int)

#define MEDIASYNC_IOC_SET_VF_SYNC_ID _IOW(MEDIASYNC_IOC_MAGIC, 0x5D, int)
